...
IL_003a:
	{
		...
		__this->___size = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_8, il2cpp_defaults.int32_class))));
...
IL_006c:
	{
		...
		DigitContainer_set_Item_m8B5D3DA91C4E5E3ADCA5F8F2A3685471BA3536D2(L_10, L_11, ((*(int64_t*)((int64_t*)(int64_t*)UnBox(L_17, il2cpp_defaults.int64_class)))), NULL);
		int32_t L_18 = V_1;
		V_1 = ((int32_t)il2cpp_codegen_add(L_18, 1));
	}
